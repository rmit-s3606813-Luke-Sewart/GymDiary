...
class CollectionViewController: UICollectionViewController {
    ...
    [
        ...
        ExerciseTut(name: "Push Up", targetedMuscles: "Pectorals\n Deltoids \n Triceps",description: "Lie on the floor face down and place your hands should width apart. Lower yourself until your chest almost touches the floor. Press your uppder body back up to starting position.", imageName: "push-up"),
        ...
        ExerciseTut(name: "Chest Fly", targetedMuscles: "Pectorals\nBiceps\nTriceps\nDeltoids",description: "Begin by holding dumbbells straight up in the air, with your palms facing inwards to each other. Lower the weights to your sides while keeping arms slightly bent. Keep elbows slightly bent and slowly return to starting position.", imageName: "chest-fly"),
        ExerciseTut(name: "Shoulder Press", targetedMuscles: "Deltoids\nTriceps\nBiceps",description: "Use a chair with back support and hold a dumbbell in each hand with arms horizontal and a 90 degree angle at elbows. Palms should be facing upwards. Push weights upwards decreasing angle at elbows and stop while elbows are still slightly bent. Return slowly to starting position while maintaining control.", imageName: "shoulder-press"),
        ExerciseTut(name: "Deadlift", targetedMuscles: "",description: "Stand with your feet underneath the barbell. Bend over and grab the bar without bending your legs. Keep arms straight and straighten your back while raising your chest. Hold for a moment and return to starting position.", imageName: "deadlift"),
        ExerciseTut(name: "Leg Curl", targetedMuscles: "ye",description: "hi", imageName: "leg-curl"),
        ExerciseTut(name: "Pull Up", targetedMuscles: "ye",description: "hi", imageName: "pull-up")
    ]
